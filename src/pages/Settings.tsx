...
import { User, Bell, Shield, Database, Users, Phone, Headphones, ChevronRight } from 'lucide-react';
...
const Settings: React.FC = () => {
  ...
  const settingsTabs = [
    ...
    { id: 'appearance', label: 'Appearance', icon: <Headphones size={20} /> },
  ];
                ...
                <div className="border-t border-gray-200 pt-6">
                  <div className="flex items-center mb-6">
                    ...
                    <div className="ml-5">
                      ...
                      <button className="px-3 py-1.5 bg-white border border-gray-300 rounded-lg text-xs font-medium text-gray-700 hover:bg-gray-50 ml-2">
                        Remove
                      </button>
                    </div>
                  </div>
